...
// is an integer which divides that number wholly (i.e. without leaving a remainder).
//
// For example, 3 is a factor of 6 because 3 fully divides 6 without leaving
