...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        com.company.Hamburger hamburger = new com.company.Hamburger("Basic", "Sausage", 3.56, "White");
        ...
        com.company.HealthyBurger healthyBurger = new com.company.HealthyBurger("Bacon", 5.67);
        healthyBurger.addHamburgerAddition1("Egg", 5.43);
        healthyBurger.addHealthAddition1("Lentils", 3.41);
        System.out.println("Total Healthy Burger price is  " + healthyBurger.itemizeHamburger());

        com.company.DeluxeBurger db = new com.company.DeluxeBurger();
