...
public class Main {
	...
	Hamburger hamburger = new Hamburger("white", "beef", 2.99);


	hamburger.setBurgerName("Mama Burger");
	hamburger.addTopping1("Lettuce", 0.99);
	hamburger.addTopping2("Peppers", 5.00);

        System.out.println(hamburger.completeBurger());

        Hamburger healthyBurger = new HealthyBurger("wheat", "chicken", 4.99);
        healthyBurger.setBurgerName("Holly Burger");
        healthyBurger.addTopping1("Lettuce", 0.99);
        healthyBurger.add
