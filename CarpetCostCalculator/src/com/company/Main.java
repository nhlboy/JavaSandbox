...
//
// The class needs to have one constructor with parameter cost of type double and it needs
...
//
// The class needs to have one constructor with parameters floor of type Floor and carpet of
// type Carpet and it needs to initialize the fields.
//
// Write the following methods (instance methods):
//
