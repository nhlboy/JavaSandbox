...
// For the complex number a + bi, a is called the real part, and b is called the
// imaginary part. To add or subtract two complex numbers, just add or subtract the
// corresponding real and imaginary parts. For instance, the sum of 5 + 3i and 4 + 2i is 9 + 5i.
...
// * Method named getImaginary without any parameters, it needs to return the value of imaginary
// field.
// * Method named add with two parameters real and imaginary of type double, it needs to add
// parameters to fields. In other words, it needs to do a complex number add operation as
// described above.
