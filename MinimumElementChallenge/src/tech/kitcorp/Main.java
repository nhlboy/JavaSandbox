...
public class Main {
    ...
    public static int[] readIntegers(int count) throws IOException {
    ...
    public static int findMin(int[] seekMinElement) {
        Arrays.sort(seekMinElement);
        return seekMinElement[0];
    }
