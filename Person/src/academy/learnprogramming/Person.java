...
public class Person {
    ...
    //  *Method named getLastName without any parameters, it needs to
    ...
    //  the value of the age field. If the parameter is less than 0 or greater
    //  than 100, it needs to set the age field value to 0.
    ...
    //  if the value of the age field is greater than 12 and less than 20, otherwise,
    //  return false.
    public boolean isTeen() {
        return age > 12 && age < 20;
    }

    //  *Method named getFullName without any parameters, it needs to return
...
//        *In case both firstName and lastName fields are empty, Strings return
//        an empty String.
...
//        or in other words, when the String does not contain any characters.
//
//
//        TEST EXAMPLE
//
