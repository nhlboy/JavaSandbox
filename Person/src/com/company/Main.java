...
// *Method named getAge without any parameters, it needs to return the value
// of the age field.

// *Method named setFirstName with one parameter of type String, it needs to
// set the value of the firstName field.
// *Method named setLastName with one parameter of type String, it needs to
